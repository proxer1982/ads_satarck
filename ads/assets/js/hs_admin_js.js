jQuery(function($){
    ...
    $('#agregar_recurso').click(function(){
        ...
        $campo_nuevo.find('.del_campo').html('<a class="button btn-default btn-eliminar-recurso" data-item=".row_recurso_' + $item + '">Eliminar</a>');
    ...
    $('#agregar_auto').click(function(){
        ...
        $campo_nuevo.find('.del_campo').html('<a class="button btn-default btn-eliminar-auto" data-item=".row_auto_' + $item + '">Eliminar</a>');
    ...
    $('#agregar_datos').click(function(){
        ...
        $campo_nuevo.find('.del_campo').html('<a class="button btn-default btn-eliminar-datos" data-item=".row_datos_' + $item + '">Eliminar</a>');
