...
class FormRenderCW
{
    ...
    public function select_desc($nombre, $etiqueta, $valor = "", $pasos, $clases = '', $print = true)
    {
        $resp = "<label class='form-label mb-1'>$etiqueta</label>
        <div class='input-group mb-3'>
            <select class='input-group-text sel-des' data-input='$nombre'>
                <option value='val' selected>$</option>
                <option value='por'>%</option>
            </select>
            <input type='number' id='$nombre' name='$nombre' class='form-control $clases' data-accion='val' data-pasos='$pasos' data-valor='$valor' min='0' step='$pasos' value='$valor'>
        </div>";
